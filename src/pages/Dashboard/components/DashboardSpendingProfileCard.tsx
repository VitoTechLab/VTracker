...
const DashboardSpendingProfileCard = () => {
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--text-muted)]">{category.percentage.toFixed(0)}% of expense</p>
                </div>
              </div>
              <p className="text-sm font-semibold text-rose-500" title={formatCurrency(category.amount)}>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-[var(--text-muted)]">
                Daily burn averages {formatCurrency(dailyBurn, 0)}. Aim for {formatCurrency(totalExpense * 0.8, 0)} or less in
                expenses to boost your runway.
              </p>
            </div>
          </div>
        </div>
...
export default DashboardSpendingProfileCard;
